			...
			<tbody>
				...
				foreach ($pdo->query($sql) as $row) {
					...
					if($row['STATUS_ID'] == 11){
						...
						echo '<td><input type="hidden" name="DisableWmanTASK" value="TRUE"><input type="Submit" class="btn btn-warning-outline btn-sm" value="Disable"></td>';
						echo '</form>';
					} else {
						echo '<form action="wman_tasks.php" method="get"><input type="hidden" name="ID" value="' . $row['ID'] . '">';
						echo '<td><input type="hidden" name="EnableWmanTASK" value="TRUE"><input type="Submit" class="btn btn-success-outline btn-sm" value="Enable"></td>';
						echo '</form>';
					}                                
        ...
        <table class="table table-compact">
            ...
            <tr>
                <form>
					...
					<td>
						<input type="hidden" name="NewWmanTASK" value="TRUE"><input type="Submit" class="btn btn-success-outline btn-sm" value="Add Workflow Mgr TASK"></td>
					</td>
				</form>
			</tr>
		</table> 
