			...
			<tbody>
				...
				foreach ($pdo->query($sql) as $row) {
					...
					if($row['STATUS_ID'] == 11){
						...
						echo '<td><input type="hidden" name="DisableQMGroupFile" value="TRUE"><input type="Submit" class="btn btn-warning-outline btn-sm" value="Disable"></td>';
						echo '</form>';
					} else {
						echo '<form action="queue_mgr_file_groups.php" method="get"><input type="hidden" name="ID" value="' . $row['ID'] . '">';
						echo '<td><input type="hidden" name="EnableQMGroupFile" value="TRUE"><input type="Submit" class="btn btn-success-outline btn-sm" value="Enable"></td>';
						echo '</form>';
					}                                
        ...
        <table class="table table-compact">
            ...
            <tr>
                <form>
					...
					<td>
						<input type="hidden" name="NewQMGroupFile" value="TRUE"><input type="Submit" class="btn btn-success-outline btn-sm" value="Add Managed File"></td>
					</td>
				</form>
			</tr>
		</table>
